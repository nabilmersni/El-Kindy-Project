...
import { getTicketsByEventId, getEventById, getTicketByIdAndEventId } from '../Event-Management/Services/apiEvent';
        ...
        <div className="ticket-container">
          {ticket ? (
            <div className="ticket-card flex relative border border-gray-300 p-4 mb-4">
              ...
              <div className="Tickets__card--header-exitBTn absolute top-0 right-0 mr-4" onClick={handleExit}>
                <svg
                ...
                <QRCode className="QRCode" value="https://www.facebook.com/elkindy.conservatoire" size={150} />
                <button className="receipt-modal-download-button block mt-4 mx-auto" onClick={downloadPDF} disabled={loader}>
                  {loader ? <span>Downloading</span> : <span>Download</span>}
                </button>
              </div>
              <div className="ticket-details flex-1 ml-4">
                <div className="mt-4">
                  <p className="text-lg font-semibold">Event Name: {ticket.event.EventName}</p>
