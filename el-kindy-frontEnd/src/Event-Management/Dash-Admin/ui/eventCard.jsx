...
import { deleteEvent, getallEvents } from "../../Services/apiEvent";
...
const EventCard = () => {
  ...
  return (
    <div>
      {eventList.map((event) => {
        const imagePath = `http://localhost:3000/upload-directory/${event.EventImage}`;

        return (
          <div key={event._id} className="dash__courses__list__card">
            ...
            <div className="dash__courses__list__card-content">
              ...
              <div className="dash__courses__list__card-content-btns">
                ...
                <div className="dash__courses__list__card-content-btns-list">
                  ...
                  <Link
                    to={`/dash-admin-Update-new-event/${event._id}`}
