...
import { removeUserFromEvent, sendNotification } from "../../Services/apiEvent";

const ManageEventParticipantItems = ({ data, fetchUsers, eventId }) => {
  ...
  const handleRemoveUser = async () => {
    try {
      await removeUserFromEvent(data._id, eventId);
      fetchUsers(eventId);
    } catch (error) {
...
export default ManageEventParticipantItems;
