...
const AdminDashUpdateEventCard = () => {
    ...
    useEffect(() => {
      ...
      const handleImageChange = (e) => {
        ...
        if (EventImage) {
          // Assuming you have a function to delete the old image (replace with your actual logic)
          deleteOldImageFunction();
        }
          ...
          <div className="course-add-form-image">
            <div className="course-add-form-image__container">
              ...
              <img
                ...
                src={EventImage && URL.createObjectURL(EventImage)}
                alt=""
                style={!EventImage ? { display: "none" } : {}}
              />
            </div>
