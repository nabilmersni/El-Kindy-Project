...
const QuizCard = ({ data }) => {
  ...
  return (
    <div>
        ...
        <div className="quiz-item-columns">
          <div className="quiz-item-column__1">
            <div className="quiz-item__title">
              Third Grade Piano Test number 1
            </div>
            <div className="quiz-item__numberOfquestion">10 questions</div>
            <div className="quiz-item__buttons">
              <div className="dash__courses__list__card-content-btns-list">
                <a
                  href="#"
                  className="dash__courses__list__card-content-btns-list__show quizes"
                >
                  <svg
                ...
                <a
                  href="#"
                  className="dash__courses__list__card-content-btns-list__update quizes"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    version="1.1"
      ...
      <ManageParticipantsModal isOpen={isModalOpen} onClose={closeModal} />
    </div>
  );
};
