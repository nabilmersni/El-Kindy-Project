...
const DashAdminSubCategoriesHeader = ({ isOpen }) => {
  return (
    <div className="dash__content__container__firstRow subcateg">
      ...
      <div className="categories-btn-toggle" onClick={isOpen}>
        Categories
      </div>
...
export default DashAdminSubCategoriesHeader;
